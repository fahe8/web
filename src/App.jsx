    ...
    <>
      <header className="">
        <div className="us-official">
          <div className="container lg:w-full md:w-[760px]">
            {" "}
       ...
       <Instructionpdf/>
        ...
        <section>
          <div className="home-wrapper py-[60px]">

            <div className="container lg:w-full sm:w-[] text-center ">
              <div className=" mx-auto pb-[60px] w-[80%] ">
                <div className="bg-[rgba(22,57,99,0.85)] py-6">
                  <h1 className="text-[1.5em] lg:text-[2.15em] font-extralight m-0  w-[80%]  mx-auto px-[24px] text-white">
                    ...
                    Apply for or Retrieve Form I-94, Request Travel History and
              ...
              <div className="w-full grid xl:grid-cols-4 lg:grid-cols-2 gap-4">
                <PanelCards />
              </div>
            </div>
            ...
            <div className=" hidden lg:block bg-white text-center pt-6 pb-14">
              ...
              <div className="bg-[#ede7dc] p-[10px] grid grid-cols-4 container lg:w-full sm:w-[] my-6">
                <FaqCards/>
              </div>
            </div>
          </div>
